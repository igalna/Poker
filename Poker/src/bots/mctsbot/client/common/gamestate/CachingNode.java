...
public class CachingNode extends ForwardingGameState {
	...
	private final static MapMaker mapmaker = new MapMaker().initialCapacity(8)
			.concurrencyLevel(3);

	private final Round round = super.getRound();

	private final TableConfiguration tableConfig = super
	...
	private final ConcurrentMap<PlayerId, PlayerState> playerStates = (ConcurrentMap<PlayerId, PlayerState>) CacheLoader
			.from(new Function<PlayerId, PlayerState>() {
				@Override
